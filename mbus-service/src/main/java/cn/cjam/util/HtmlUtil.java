...
public class HtmlUtil {
    ...
    static Pattern jsCompile = Pattern.compile(jsRegex);
...
//            System.out.println("="+matcher.group()+"=");
    ...
    public static String clearJs(String input){
        if (StringUtils.isBlank(input)){
            return "";
        }
        Matcher matcher = jsCompile.matcher(input);
        StringBuffer stringBuffer = new StringBuffer();
        while (matcher.find()){
            matcher.appendReplacement(stringBuffer,"");
//            System.out.println("="+matcher.group()+"=");
...
//        System.out.println("=="+s);
        ...
        String input = "$d((gdfgdfgdf);";
        String s = clearJs(input);
        System.out.println("=="+s);
